(function (global, factory) {
    ...
    */
        ...
        React.useEffect(function () {
            ...
            var listener = function (evt) {
                ...
                if (tip !== null) {
                    ...
                    tooltip.style.left = "".concat(evt.clientX + window.scrollX, "px");
                    tooltip.style.top = "".concat(evt.clientY + window.scrollY, "px");
            ...
            React.createElement("div", { className: "react-supervenn-layout" },
                ...
                React.createElement("div", { className: "react-supervenn-ycount" }, chunks.map(function (chunk, col) { return (React.createElement("div", { key: col, style: {
                    ...
                    chunks[col].length >= effective_min_width_for_annotation ?
                        chunks[col].length
                        : null,
                    React.createElement("div", { className: "react-supervenn-ycount-count" }, chunks[col].length >= effective_min_width_for_annotation ?
                        ycounts[col]
                        : null),
                    React.createElement("div", { className: "react-supervenn-ycount-bar", style: {
    ...
    function ReactSupervenn(container, props) {
        var height = props.height !== undefined ? props.height : '500px';
        ReactDOM.render(React.createElement("div", { style: {
            ...
            React.createElement(ReactSupervenn$1, __assign({}, props))), container);
    }

    exports.ReactSupervenn = ReactSupervenn;
